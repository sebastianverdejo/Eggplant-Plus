...
var lays = global.paniclayercount
...
for (var i = 0; i < array_length(lay_arr); i++)
{
    ...
    switch lay_name
    {
        ...
        case "Assets_stillBG":
            layer_x(lay, (_cam_x * 0.1))
            break
        case "Backgrounds_completelystill1":
        case "Backgrounds_4":
            layer_x(lay, 0)
            layer_y(lay, 0)
            break
        ...
        case "Backgrounds_stillscroll":
            ...
            bg_scrollx += (layer_get_hspeed(lay) / lays)
            bg_scrolly += (layer_get_vspeed(lay) / lays)
            break
        case "Backgrounds_stillH1":
            ...
            bg_stillH1xoffset += (layer_get_hspeed(lay) / lays)
            bg_stillH1yoffset += (layer_get_vspeed(lay) / lays)
            break
        case "Backgrounds_stillH2":
            ...
            bg_stillH2xoffset += (layer_get_hspeed(lay) / lays)
            bg_stillH2yoffset += (layer_get_vspeed(lay) / lays)
            break
        case "Backgrounds_stillH3":
            ...
            bg_stillH3xoffset += (layer_get_hspeed(lay) / lays)
            bg_stillH3yoffset += (layer_get_vspeed(lay) / lays)
            break
        case "Backgrounds_stillH4":
            ...
            bg_stillH4xoffset += (layer_get_hspeed(lay) / lays)
            bg_stillH4yoffset += (layer_get_vspeed(lay) / lays)
            break
        ...
        case "Backgrounds_scroll2":
            ...
            bg_scroll2x += (layer_get_hspeed(lay) / lays)
            bg_scroll2y += (layer_get_vspeed(lay) / lays)
            break
        case "Backgrounds_scroll3":
            ...
            bg_scroll3x += (layer_get_hspeed(lay) / lays)
            bg_scroll3y += (layer_get_vspeed(lay) / lays)
            break
        case "Backgrounds_scroll4":
            ...
            bg_scroll4x += (layer_get_hspeed(lay) / lays)
            bg_scroll4y += (layer_get_vspeed(lay) / lays)
            break
        ...
        case "Foreground_1":
            ...
            fg_speed += (layer_get_vspeed(lay) / lays)
            break
        case "Foreground_2":
