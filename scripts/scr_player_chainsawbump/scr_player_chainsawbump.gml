function scr_player_chainsawbump()
{
    ...
    if ((!key_chainsaw2) && (sprite_index == spr_player_chainsawidle))
    {
        vsp = -5
    ...
    if (chainsawbuffer <= 0 && (sprite_index == spr_player_chainsawdash))
    {
		state = states.mach3
		sprite_index = spr_mach4
		chainsawbuffer = 0;
    }
	if ((floor(image_index) == (image_number - 1)) && (sprite_index == spr_player_chainsawhit))
	{
		image_index = 0;
        sprite_index = spr_player_chainsawdash;
	}
