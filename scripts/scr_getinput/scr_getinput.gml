...
function scr_getinput()
{
	...
	if global.swapmode && _dvc != _dvc2
	{
		...
		key_chainsaw_p2 = (_dvc2 >= 0) ? tdp_input_get("player_chainsawC").pressed : tdp_input_get("player_chainsaw").pressed;
		key_shoot_p2 = (_dvc2 >= 0) ? tdp_input_get("player_shootC").pressed : tdp_input_get("player_shoot").pressed;
	...
	if (!global.swapmode || _dvc == -1)
	{
		...
		key_shoot = tdp_input_get("player_shootC").pressed || tdp_input_get("player_shoot").pressed;
		key_shoot2 = tdp_input_get("player_shootC").held || tdp_input_get("player_shoot").held;
		key_chainsaw = tdp_input_get("player_chainsawC").pressed || tdp_input_get("player_chainsaw").pressed;
		key_chainsaw2 = tdp_input_get("player_chainsawC").held || tdp_input_get("player_chainsaw").held;
	}
	else if _dvc >= 0
	{
		...
		key_shoot2 = tdp_input_get("player_shootC").held;
		key_chainsaw = tdp_input_get("player_chainsawC").pressed;
		key_chainsaw2 = tdp_input_get("player_chainsawC").held;
	}
